            ...
            <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" id="row2-1">
                            ...
                            <ul class="top" id="navbar">
                              <li><a id="top" href="arrival.php">Arrival</a></li>
                              <li><a class="active" id="top" href="return.php">Return</a></li>            
                            </ul>

                        <form action="returnAction.php" method="post" target="_blank" enctype="multipart/form-data">    
                            <div class="form-group">
                                    ...
                                    <input type="date" name="dor" id="dor"><br>
                                    
                                    <label id="return" for="mode">Mode:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    ...
                                    <label id="return" for="pick">Drop point:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
