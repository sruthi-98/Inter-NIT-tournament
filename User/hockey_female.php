            ...
            <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" id="row2-1">
                      <ul>
                        ...
                        <li><a class="active" href="hockey_male.php">Register</a></li>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" id="row2-1">
                            ...
                            <ul class="top sticky" id="navbar">
                              <li><a class="male" id="top" href="hockey_male.php">Male Team</a></li>
                              <script type="text/javascript">
                              ...
                              <li><a class="active female" id="top" href="hockey_female.php">Female Team</a></li>
                              <script type="text/javascript">
                            ...
                            <form action="formaction.php" method="POST">
                                <div class="form-group">
                                  ...
                                  <input name="sp" type="number" min=0 max=16 id="si" value="<?php echo( htmlspecialchars( $state_player ) ); ?>">
                                  <hr/>
